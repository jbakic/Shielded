...
namespace ShieldedTests
{
    ...
    public class SeqTests
    {
        ...
        public void BasicOps()
        {
            ...
            Assert.AreEqual(20, Shield.InTransaction(() => seq.Count()));
            ...
            Assert.AreEqual(21, Shield.InTransaction(() => seq.Count()));
            ...
            Assert.AreEqual(10, Shield.InTransaction(() => seq.Count()));
            for (int i = 0; i < 10; i++)
            ...
            Assert.AreEqual(0, Shield.InTransaction(() => seq.Count()));
            Shield.InTransaction(() => seq2.Clear());
            Assert.AreEqual(0, Shield.InTransaction(() => seq2.Count()));
        }
    }
}
